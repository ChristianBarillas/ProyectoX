            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <Link to='/'>Home</Link><i class="fa fa-angle-double-right"></i><span>Políticas</span>
                    </div> 
                     {/* end of breadcrumbs  */}
                </div>  {/* end of col  */}
            </div> {/* end of row  */}
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p>Esta se aplica a todos los sitios de Internet y/o aplicaciones móviles administrados por <a class="green" href="#your-link">GOSEN S&T</a> por ejemplo:</p>
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="list-unstyled li-space-lg indent">
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Dirección IP de conexión, en algunos casos el nombre de su ISP o proveedor local de servicios de Internet</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">MacID del dispositivo de ingreso a las diferentes plataformas</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Fecha y hora de conexión</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Zona horaria y región geográfica</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Número de conexiones por usuario y Cookies. También el sistema operativo del dispositivo usado para interconectar con las diferentes plataformas o apps móviles pertenecientes a Gosén</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Log de actividades dentro de las plataformas pertenecientes a Gosén S&T </div>
                                    </li>
                                </ul>
                            </div>  {/* end of col  */}
                            ...
                            <div class="col-md-6">
                                <ul class="list-unstyled li-space-lg indent">
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Su dirección de facturación y cualquier otra información necesaria para completar cualquier transacción financiera y al realizar compras a través de los servicios electrónicos de Gosén, también podemos recopilar su tarjeta de crédito/débito o información de PayPal</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Contenido generado por el usuario (como mensajes, publicaciones, comentarios, páginas, perfiles, imágenes, fuentes o comunicaciones intercambiadas en las Plataformas admitidas)</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Logos o imagenes compartidas en su perfil de ingreso a plataforma</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Información diversa de actividad dentro de las plataformas pertenecientes a Gosén S&T </div>
                                    </li>
                                </ul>
                            </div>  {/* end of col  */}
                        </div>   {/* end of row */}
                    ...
                    <div class="text-container">
					    ...
					    <p class="mb-5">Al usar cualquiera de los servicios y/o plataformas, al enviar o recopilar cualquier Información personal de sus clientes a través de ellos, usted acepta: la recopilación, transferencia, almacenamiento y uso de su información en la manera establecida en esta Política de privacidad.</p>
                    </div>  {/* end of text-container  */}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="text-container last">
                                ...
                                <p> Al visitar el Landing Page, usted acepta el uso de cookies en su navegador y correos electrónicos basados en HTML. Las cookies son pequeños archivos de texto que se colocan en su dispositivo cuando visita un sitio web. Al usar cualquiera de ellos o enviar o recopilar cualquier información personal a través de los servicios, usted acepta el uso de dicha <a class="green" href="#your-link">Información Personal</a></p>
                            </div> {/* end of text container  */}
                        </div>   {/* end of col */}
                        <div class="col-md-6">
                    ...
                    <Link class="btn-outline-reg back" to='/'>ATRAS</Link>
                </div>     {/* end of col */}
            </div>   {/* end of row  */}
        </div>  {/* end of container  */}

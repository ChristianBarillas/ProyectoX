            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <Link to='/'>Home</Link><i class="fa fa-angle-double-right"></i><span>Términos y Condiciones</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p>Cuando se registra por primera vez en una plataforma de Gosén S&T y al utilizar los servicios, recopilamos cierta <a class="green" href="#your-link">Información Personal</a>, como:</p>
                        <ul class="list-unstyled li-space-lg indent">
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Su nombre completo, de usuario, dirección de correo electrónico y otros datos de contacto</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">ID de usuario único que se le asigna al registrarse en nuestros servicios</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Otra información opcional parte del perfil de su cuenta</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Su dirección IP y cuando corresponda, la marca de tiempo relacionada con su consentimiento y confirmación de aceptacion</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Otra información enviada por usted o los representantes de su organización a través de varios métodos</div>
                            </li>
                        </ul>
